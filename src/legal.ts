// Shared legal wording used by BOTH the first-launch gate (Onboarding) and the More
// tab's Legal section, so the two can never drift apart. Keep edits here, not inline.
//
...
/** One-line summary of copyright/ownership for the More tab. */
export const COPYRIGHT_SUMMARY =
  `${COPYRIGHT_LINE} The app, its name, design, and code are the property of the developer.`
